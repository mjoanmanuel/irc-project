...
import com.project.ircserver.Connector;
...
public class SettingPanel extends CommonPanel {
	...
	private static final String I18N_FILE = SettingPanel.class.getCanonicalName();
	...
	protected void onClick() {
		if (validateInformation()) {
			...
			final Connector conn = new Connector(host);
